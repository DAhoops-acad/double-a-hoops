...
const coaches = [
  {
    ...
    specialties: ["Shooting Mechanics", "Ball Handling", "Offensive Moves"],
    initial: "A",
  ...
  },
  {
    name: "Aneesh",
    role: "Head Coach & Co-Founder",
    bio: "Aneesh brings energy and intensity to every session. Known for his ability to push players beyond their comfort zones while keeping training fun, he specializes in developing mental toughness and competitive mindset.",
    specialties: ["Defense", "Mental Toughness", "Game Situations"],
    initial: "A",
